...
//
// Ported forward from wesser/main (commit 9c81711) which carried this data
// in `data/insee-departments.ts`. The branch this lives on dropped that
// directory during the src/ restructure, so the dataset has been moved
// here without changes. Currently 22 départements; expand as needed.

    ...
    <div className={`fixed bottom-12 right-12 w-full max-w-lg z-[600] transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] translate-x-0 opacity-100 scale-100`}>
      <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-3xl border border-white/50 dark:border-slate-700/50 shadow-[0_45px_100px_-25px_rgba(0,0,0,0.18)] rounded-[3.5rem] overflow-hidden flex flex-col">
        <div className="p-12 border-b border-slate-100/60 dark:border-slate-800/60 flex items-center justify-between bg-white/40 dark:bg-slate-800/40">
          <div className="flex items-center gap-10">
            ...
            <div>
              ...
              <div className="flex gap-5 mt-4">
                ...
                <span className="text-[12px] font-black text-white uppercase tracking-widest flex items-center gap-2.5 bg-slate-900 px-4 py-2 rounded-2xl shadow-xl"><Clock size={16} strokeWidth={2.5} className="text-slate-500 dark:text-slate-300" /> {selectedCluster.durationWeeks} sem.</span>
                {/* Weather indicator */}
                {weatherLoading ? (
          ...
          <button onClick={onClose} className="p-5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-400 dark:text-slate-300 hover:text-slate-600 dark:hover:text-slate-200 rounded-[1.5rem] transition-all"><X size={28} strokeWidth={2.5} /></button>
        </div>
        ...
        <div className="p-10 bg-white/60 dark:bg-slate-800/60 border-t border-slate-100/60 dark:border-slate-800/60 flex justify-end gap-5">
          <button onClick={() => onPutBackToDraft(selectedCluster.id)} className="px-10 py-5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-300 rounded-2xl text-[12px] font-black uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-slate-700 transition-all">Retirer</button>

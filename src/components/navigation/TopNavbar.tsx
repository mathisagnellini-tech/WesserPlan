        ...
        <div className="max-w-[1920px] mx-auto flex items-center h-16 px-4 lg:px-6 gap-3 lg:gap-6">
          ...
          <div className="flex items-center gap-1.5 lg:gap-2 shrink-0">
            ...
            <button
              ...
              onClick={() => navigate("/settings")}
              aria-label={
                userName ? `Paramètres — ${userName}` : "Paramètres du compte"
              }
              title="Paramètres"
            ...
            >
              ...
              <span
                aria-hidden="true"
                className="absolute bottom-0 right-0 w-2 h-2 lg:w-2.5 lg:h-2.5 bg-green-500 border-2 border-[var(--bg-card-solid)] rounded-full"
              ></span>
            </button>
          </div>
        </div>

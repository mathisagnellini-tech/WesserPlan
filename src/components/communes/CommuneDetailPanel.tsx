...
import { Users, Euro, Clock, Info, Phone, Mail, History, Calendar } from 'lucide-react';
...
export const CommuneDetailPanel: React.FC<CommuneDetailPanelProps> = ({ commune, onUpdateCommune }) => {
    if (!commune) {
        return (

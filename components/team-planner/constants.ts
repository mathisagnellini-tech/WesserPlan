...
import { BoardData, Column, Person, Relationship, WeekStatus } from './types';
...
const NGO_COLORS: Record<string, string> = {
    'UNICEF': 'bg-cyan-500', // Cyan standard UNICEF
    'MSF': 'bg-red-600', // Rouge vif
    'Croix-Rouge': 'bg-red-500', // Rouge
    'WWF': 'bg-emerald-600', // Vert Panda
